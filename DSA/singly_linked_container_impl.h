...
namespace DSA
{
    ...
    template <class T>
    void singly_linked_container<T>::insert_front(const T &entry)
    {
        node_ptr new_node
    ...
    template <class T>
    void singly_linked_container<T>::insert_entry(const size_t &index, const T &entry)
    {
    ...
    template <class T>
    singly_linked_container<T>::s_linked_container()
        : m_head(), m_tail() {}
#else
    template <class T>
    singly_linked_container<T>::s_linked_container()
